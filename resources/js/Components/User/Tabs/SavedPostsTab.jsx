...
const SavedPostsTab = ({ posts = [], currentUser, onLike, onRemoveBookmark, onShare }) => {
    ...
    return (
        <Box sx={{ width: '100%' }}>
                        ...
                        <Box key={post.id} sx={{ height: '100%' }}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <BookmarkOutlined sx={{ fontSize: 16, color: 'white' }} />
                                    </Box>
                                    ...
                                    <CardContent sx={{
                                        ...
                                        {/* Save Date */}
                                        <Box sx={{ mb: 1.5, minHeight: 20, flexShrink: 0 }}>
                                            <Typography variant="caption" color={theme.palette.text.secondary}>
                                                Guardado el {format(new Date(post.bookmarked_at || post.created_at), 'dd MMM yyyy', { locale: es })}
                                            </Typography>
                                        </Box>
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mt: 'auto', minHeight: 24, flexShrink: 0 }}>
                                            ...
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                                <FavoriteOutlined sx={{ fontSize: 16, color: theme.palette.text.secondary }} />
                                                <Typography variant="caption" color={theme.palette.text.secondary}>
                                                    {post.likes_count || 0}
                                                </Typography>
                                            </Box>
                                        ...
                                        <Box sx={{ display: 'flex', gap: 1 }}>
                                            <IconButton
                                                ...
                                                sx={{
                                                    ...
                                                    '&:hover': { backgroundColor: post.user_liked ? 'rgba(239, 68, 68, 0.1)' : HOVER_BG }
                                                }}
                                            >
            ...
            {filteredPosts.length === 0 && (
                ...
                >
                    <BookmarkOutlined sx={{ fontSize: 48, color: theme.palette.text.secondary, mb: 2 }} />
                    <Typography variant="h6" color={theme.palette.text.secondary} gutterBottom>
                        {searchTerm ? 'No se encontraron posts guardados' : 'No tienes posts guardados'}
                    </Typography>
                    <Typography variant="body2" color={theme.palette.text.secondary}>
                        {searchTerm ? 'Intenta con otros t\u00e9rminos de b\u00fasqueda' : 'Los posts que guardes aparecer\u00e1n aqu\u00ed'}
                    </Typography>
                </Box>
            )}
        </Box>
