    ...
    return (
        ...
        <Box>
            ...
            <Paper variant="outlined" sx={{ p: 3, mb: 3 }}>
                <Typography variant="overline" sx={{ color: 'text.secondary' }}>Cuentas Conectadas</Typography>
            ...
            <Paper variant="outlined" sx={{ p: 3 }}>
                <Typography variant="overline" sx={{ color: 'text.secondary' }}>Resumen</Typography>
