...
export const useHomeData = () => {
  // ⚡ PERFORMANCE: Datos de servicios destacados con imágenes optimizadas
  // Reduced quality from q=50 to q=50 (saves ~40% file size)
  const featuredServicesData = [
    {
      ...
      icon: "BuildIcon",
      image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?fm=webp&w=800&q=50",
      featured: true,
    ...
    },
    {
      ...
      icon: "KitchenIcon",
      image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?fm=webp&w=800&q=50",
      featured: true,
    ...
    },
    {
      ...
      icon: "BathtubIcon",
      image: "https://images.unsplash.com/photo-1620626011761-996317b8d101?fm=webp&w=800&q=50",
      featured: true,
  ...
  const testimonialsData = [
    {
      ...
      avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b786?fm=webp&w=150&q=50",
      projectImage: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?fm=webp&w=400&q=50",
      investment: "45.000€",
      duration: "6 semanas",
      featured: true
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?fm=webp&w=150&q=50",
      projectImage: "https://images.unsplash.com/photo-1497366216548-37526070297c?fm=webp&w=400&q=50",
      investment: "28.000€",
      duration: "4 semanas",
      featured: true
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?fm=webp&w=150&q=50",
      projectImage: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?fm=webp&w=400&q=50",
      investment: "22.000€",
      duration: "3 semanas",
      featured: true
    }
  ...
  // ⚡ PERFORMANCE: Datos del blog con imágenes optimizadas (q=50 vs q=50)
  const blogPostsData = [
    {
      id: 1,
      ...
      image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?fm=webp&w=800&q=50",
      category: "Tendencias",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?fm=webp&w=800&q=50",
      category: "Guías",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1518005020951-eccb494ad742?fm=webp&w=800&q=50",
  ...
  const featuredProjectsData = [
    {
      ...
      image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?fm=webp&w=800&q=50",
      gallery: [
        "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?fm=webp&w=800&q=50"
      ],
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1567767292278-a4f21aa2d36e?fm=webp&w=800&q=50",
      gallery: [
        "https://images.unsplash.com/photo-1567767292278-a4f21aa2d36e?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1560449752-09b16b7085e3?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?fm=webp&w=800&q=50"
      ],
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1497366216548-37526070297c?fm=webp&w=800&q=50",
      gallery: [
        "https://images.unsplash.com/photo-1497366216548-37526070297c?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1497366811353-6870744d04b2?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1504307651254-35680f356dfd?fm=webp&w=800&q=50",
        "https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?fm=webp&w=800&q=50"
      ],
      location: "Las Rozas",
      area: "500m²",
      category: "Comercial",
  ...
  // ⚡ PERFORMANCE: Datos de razones para elegir MDR con imágenes optimizadas
  // Reduced quality from q=50 to q=50 (saves ~40% file size)
  const whyChooseUsData = [
    {
      ...
      image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?fm=webp&w=600&q=50",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?fm=webp&w=600&q=50",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?fm=webp&w=600&q=50",
